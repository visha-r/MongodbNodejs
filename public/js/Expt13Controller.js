...
app.config(function ($routeProvider, $httpProvider) {
    $routeProvider
     ...
     .when('/showUserDetails/:username', {
        templateUrl: 'partials/NewUserDetails.html',
        controller: 'UserDetailsController'
    })
    
     .when('/profile', {
        templateUrl: 'partials/NewUserProfileWithReviews.html',
...
//			User is Authenticated
			if (result !== '0'){
				...
				console.log($scope.followsAlready);
...
app.controller('UserProfileController', function ($scope, $http, $routeParams, UserService, ProductService, $rootScope) {
	...
	UserService.getUserDetails($scope.username, function(response){
		...
		$rootScope.cartCount = $scope.user.cart.length;
